...
- 비밀번호
- 로그인 시 실행 여부
- 월요일부터 금요일까지의 출근/퇴근 알림 발생 시간

비밀번호는 macOS Keychain에 저장됩니다.

기본 알림 발생 시간은 다음과 같습니다.

- 월/금: 출근 알림 08:50, 퇴근 알림 18:10
- 화/수/목: 출근 알림 08:20, 퇴근 알림 17:40
...
- `설정`: 사이트 URL, 아이디, 비밀번호, 알림 발생 시간을 수정합니다.
- `종료`: 앱을 종료합니다.

스케줄 알림은 앱이 실행 중일 때만 동작합니다. 출근/퇴근 알림은 설정한 알림 발생 시간에 표시됩니다. 알림 창은 버튼을 누르거나 닫기 전까지 유지됩니다.
